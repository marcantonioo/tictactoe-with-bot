...
bin/unit-Tabuleiro.o: test/unit-Tabuleiro.cpp
	g++ -c -Wextra test/unit-Tabuleiro.cpp -o bin/unit-Tabuleiro.o

bin/unitMain.o: test/main.cpp
	g++ -c -Wextra test/main.cpp -o bin/unitMain.o
